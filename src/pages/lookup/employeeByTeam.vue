...
const projectId = ref(props.projectTeam)
...
const fetchEmployee = async (page, perPage, find, id) => {
  try {
   
    const response = await axiosIns.get(`/employment/by/team/${id}`, {
...
watchEffect(() => {
  fetchEmployee(page.value, perPage.value, find.value, projectId.value)
})
