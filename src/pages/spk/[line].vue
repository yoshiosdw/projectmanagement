...
const spkHeaderId = ref(route.params.line)
const spk = ref(null)
...
const createSpkLine = async() => {
  ...
  const body = {
    ...
    output_target: totalMaterial.value,
            ...
            <table v-if="spk && spk.length > 0">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="font-weight-semi-bold">
                    : {{ formatRibuan(spk[0].quantity) }} {{ spk[0].uom.code }}
                  </td>
                  <td style="width: 50px;" />
                  <td class="pe-5">
                    Item Size
                ...
                <tr>
                  ...
                  <td class="font-weight-semi-bold">
                    : {{ formatRibuan(spk[0].quantity_in_kg) }}
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                ...
                >
                  ...
                  <td style="text-align: right">
                    {{ formatRibuan(data.waste_target) }}
                  </td>
                  <td style="text-align: right">
                    {{ formatRibuan(data.output_target) }}
                  </td>
                  <td>
                    {{ data.plant_origin }}
                  </td>
