...
const fetchIssue = async(page, perPage, find) => {
  ...
  try {
    const ret = await axiosIns.get('/ict/issue/', {
...
const deleteData = async issueId => {
  showLoading.value = true
  try {
    const ret = await axiosIns.delete(`/ict/issue/${issueId}` )
                  ...
                  <div class="d-flex justify-start">
                    ...
                    >
                      ...
                      <VMenu activator="parent">
                        <VList width="15rem">
                          <VListItem :to="{ name: 'ict-issue-id', params: { id: data.id } }">
                            <VListItemTitle>
                              <VIcon
                                icon="tabler-pencil" 
                                variant="primary" 
