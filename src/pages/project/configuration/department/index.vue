...
const fetchDepartment = async (page, perPage, find) => {
...
const deleteData = async id => {
  ...
  try {
    const ret = await axiosIns.delete(`/projectDepartment/${id}` )

    fetchDepartment(page.value, perPage.value, find.value),
      ...
      <VCard :loading="showLoading">
        <VRow>
          <VCol cols="12">
            <VCardText class="d-flex gap-4">
              ...
              <Add
                @closed="getClosed"
                @saved="fetchDepartment(page.value, perPage.value, find.value)"
              />
            </VCardText>
          </VCol>
        </VRow>
        ...
        <VCardText>
          <VTable>
            ...
            <tbody>
              <tr
                v-for="(data, index) in department"
                :key="index"
              >
