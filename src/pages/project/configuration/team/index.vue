...
const fetchTeam = async (page, perPage, find) => {
  showLoading.value = true
  try {
    const ret = await axiosIns.get('/project/teams', {
      params: {
        page: page,
        perPage: perPage,
        find: find,
...
const deleteData = async id => {
  ...
  try {
    const ret = await axiosIns.delete(`/project/teams/${id}` )
